...
<body>
    ...
    <div class="container-fluid" id="banner">
        <div id="form" class="col-sm-7">
            ...
            <table class="table">
                ...
                <tr>
                    <td>
                        <center><?php echo $res2->id; ?></center>
                    </td>
                    <td>
                        <center><?= $res2->name; ?></center>
                    </td>
                    <td>
                        <center><?= $res2->price; ?></center>
                    </td>
                    <td>
                        <center><?= anchor('admin_welcome/delete_product/' . $res2->id, 'Delete', ['class' => 'btn btn-primary']); ?></center>
                    </td>
                    <td>
                        <center><?= anchor('admin_welcome/update_product/' . $res2->id, 'Update', ['class' => 'btn btn-primary']); ?></center>
                    </td>
                </tr>
                <?php 
			}
    ...
    <div class="container-fluid" style="background:blue;color:white;">
        <h2 align="center">THE BLAZZERS</h2>
    </div>
</body>
